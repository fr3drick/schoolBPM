...
export const DEFAULT_ROLES = [
  ...
  },
  {
    ...
    permissions: ['instances.initiate', 'instances.act', 'instances.view_all', 'definitions.manage', 'audit.view', 'email.view', 'students.view', 'students.manage', 'classes.manage', 'subjects.manage'],
  },
  {
    name: 'Proprietor',
    description: 'School proprietor',
    permissions: ['instances.initiate', 'instances.act', 'instances.view_all', 'audit.view', 'email.view', 'students.view', 'students.manage', 'classes.manage', 'subjects.manage'],
  },
  {
    name: 'Principal',
    description: 'Head of school',
    permissions: ['instances.initiate', 'instances.act', 'instances.view_all', 'definitions.manage', 'audit.view', 'students.view', 'students.manage', 'classes.manage', 'subjects.manage'],
  },
  {
    name: 'Admin',
    description: 'School administrator',
    permissions: ['instances.initiate', 'instances.act', 'instances.view_all', 'definitions.manage', 'students.view', 'students.manage', 'classes.manage', 'subjects.manage'],
  },
  {
    name: 'Teacher',
    description: 'Teaching staff',
    permissions: ['instances.initiate', 'instances.act', 'students.view'],
  },
];
